...
public class depositar extends javax.swing.JFrame {
    ...
    public depositar() {
        ...
        this.setLocationRelativeTo(depositar.this);
    ...
    private void initComponents() {
        ...
        bolivianos.setText("Deposito Dolares");
        bolivianos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bolivianosActionPerformed(evt);
            }
        });
        jPanel2.add(bolivianos, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 410, 230, 70));
        ...
        bolivianos1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/icons8-efectivo-en-mano-32.png"))); // NOI18N
        bolivianos1.setText("Deposito Bolivianos");
        bolivianos1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bolivianos1ActionPerformed(evt);
            }
        });
        jPanel2.add(bolivianos1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 410, 250, 70));

        fechaaa.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        fechaaa.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(fechaaa, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 330, 50));
